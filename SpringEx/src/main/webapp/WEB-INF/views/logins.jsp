...
<body>
	...
	<div id="container">
		<div id="huzi-container">
			<img src="/resources/img/huzz.jpg" id="huzi"> <img
				src="/resources/img/logo copy.png" id="huzilogo">
		</div>
		<div id="main-container">
			<div id="main">
				...
				<form id="loginForm"
					...
					<div id="id_save">
						<input type="checkbox" name="autoLogin" value="true"> <label
							for="autoLogin">자동 로그인</label>
					</div>
					<button id="loginButton" type="submit">로그인</button>
					<a href="#" id="join" class="logo lojo">회원가입</a>
					<button onclick="window.location.href='/account/search_id'"
						id="findid" class="btn btn-facebook btn-user btn-block">
						아이디찾기</button>

					<button onclick="window.location.href='/account/search_pwd'"
						id="findpass" class="btn btn-warning btn-user btn-block">
						비밀번호찾기</button>
					<br>
					<div class="container">
						<div class="item">
							<a href="#" id="kakaoLogin"> <img
								src="/resources/img/kakao_logo.png" alt="카카오 로고">
								<div>
									<strong>카카오톡</strong> <span>카카오 로그인</span>
								</div>
							</a>
						</div>
