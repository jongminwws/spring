...
<body>
    <header>
        ...
        <div class="header_2">
            <div class="logo">
                <a href="index.html"><img src="/resources/img/Logo_white 1.png" alt="Hospital_logo" /></a>
            </div>
    ...
    <main>
        <div>
            <ul class="slider-container">
                <li class="slide1">
                    <img src="/resources/img/slide_1.png" alt="">
                </li>
                <li class="slide2">
                    <img src="/resources/img/slide_2.png" alt="">
                </li>
                <li class="slide3">
                    <img src="/resources/img/slide_3.png" alt="">
                </li>
                <li class="slide4">
                    <img src="/resources/img/slide_4.png" alt="">
                </li>
            </ul>
            <div class="remort">
        ...
        <div class="quick_menu_container">
            <a href="#">
                <img class="icon" src="/resources/img/icon_hover_1.png" alt="quick_menu_button_unhover">
                <img class="icon_hover" src="/resources/img/icon_1.png" alt="quick_menu_button_hover">
            </a>
            <a href="#">
                <img class="icon" src="/resources/img/icon_hover_2.png" alt="quick_menu_button_unhover">
                <img class="icon_hover" src="/resources/img/icon_2.png" alt="quick_menu_button_hover">
            </a>
            <a href="#">
                <img class="icon" src="/resources/img/icon_hover_3.png" alt="quick_menu_button_unhover">
                <img class="icon_hover" src="/resources/img/icon_3.png" alt="quick_menu_button_hover">
            </a>
            <a href="#">
                <img class="icon" src="/resources/img/icon_hover_4.png" alt="quick_menu_button_unhover">
                <img class="icon_hover" src="/resources/img/icon_4.png" alt="quick_menu_button_hover">
            </a>
            <a href="#">
                <img class="icon" src="/resources/img/icon_hover_5.png" alt="quick_menu_button_unhover">
                <img class="icon_hover" src="/resources/img/icon_5.png" alt="quick_menu_button_hover">
            </a>
        </div>
        <div class="ad_container">
            <a href="">
                <img src="/resources/img/AD.png" alt="ad_image">
            </a>
        </div>
        <div class="notices_container">
            <a>
                <img src="/resources/img/notice.png" alt="">
            </a>
            <div class="notice">
